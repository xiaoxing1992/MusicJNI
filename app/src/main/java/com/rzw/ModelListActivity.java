...
import com.rzw.render.FGLViewActivity;

import java.util.ArrayList;

public class ModelListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.MenuHolder>{
        ...
        class MenuHolder extends RecyclerView.ViewHolder{
            ...
            MenuHolder(View itemView) {
                ...
                mBtn.setOnClickListener(ModelListActivity.this);
            }
